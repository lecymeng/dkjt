...
public abstract class NavigationDrawer<Fragment> extends AppCompatActivity implements SectionListener {
  ...
  private void setFragment (Fragment fragment, String title, boolean head) {
    ...
    if (fragment instanceof android.app.Fragment) {
      ...
      getSupportFragmentManager().beginTransaction()
          .replace(R.id.frame_container, (android.support.v4.app.Fragment) fragment)
          .commit();
    } else {
    ...
    if (head == false) layout.closeDrawer(drawer);
  }
  ...
  private void addSection (Section section) {
    ...
    LinearLayout.LayoutParams params =
        new LinearLayout.LayoutParams(ViewGroup.LayoutParams.MATCH_PARENT, (int) (48 * density));
