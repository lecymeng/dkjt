...
public class MainActivity extends NavigationDrawer implements NavigationDrawerListener {
    ...
    for (String key : map.keySet()) {
      if (key.equals(brandString)) {
        getFragmentManager().beginTransaction()
            .replace(com.sspai.navigationdrawer.R.id.frame_container, HomeFragment.newInstance(brandString))
            .commit();
      }
    }
  }
  ...
  public void init (Bundle savedInstanceState) {
    ...
    section1 = this.newSection(map.get("google"),
        TextDrawable.builder().buildRound("", getResources().getColor(R.color.google_color)),
        HomeFragment.newInstance("google"), false);
    ...
    Section section2 = this.newSection(map.get("samsung"),
        TextDrawable.builder().buildRound("", getResources().getColor(R.color.samsung_color)), false);
    ...
    Section section3 = this.newSection(map.get("htc"),
        TextDrawable.builder().buildRound("", getResources().getColor(R.color.htc_color)), false);
    ...
    Section section4 = this.newSection(map.get("Sony"),
        TextDrawable.builder().buildRound("", getResources().getColor(R.color.sony_color)), false);
    ...
    Section section5 = this.newSection(map.get("lge"),
        TextDrawable.builder().buildRound("", getResources().getColor(R.color.lge_color)), false);
    ...
    Section section6 = this.newSection(map.get("Huawei"),
        TextDrawable.builder().buildRound("", getResources().getColor(R.color.huawei_color)), false);
    ...
    Section section7 = this.newSection(map.get("nubia"),
        TextDrawable.builder().buildRound("", getResources().getColor(R.color.nubia_color)), false);
    ...
    Section section8 = this.newSection(map.get("Xiaomi"),
        TextDrawable.builder().buildRound("", getResources().getColor(R.color.xiaomi_color)), false);
    ...
    Section section9 = this.newSection(map.get("Meizu"),
        TextDrawable.builder().buildRound("", getResources().getColor(R.color.meizu_color)), false);
    ...
    Section section10 = this.newSection(map.get("ONEPLUS"),
        TextDrawable.builder().buildRound("", getResources().getColor(R.color.oneplue_color)), false);
    ...
    Section section11 = this.newSection(map.get("smartisan"),
        TextDrawable.builder().buildRound("", getResources().getColor(R.color.smartisan_color)), false);
    ...
    Section section12 = this.newSection(map.get("other"),
        TextDrawable.builder().buildRound("", getResources().getColor(R.color.other_color)), false);
    ...
    HeadItem headItem1 =
        new HeadItem("少数派出品", "", null, this.getResources().getDrawable(R.drawable.menu_banner), menu1, 0);
   ...
   */
  void updateBooleanPreference (boolean newSettingEnabled, BooleanPreference booleanPreference, String enabledText,
      String disabledText) {
  ...
  public void switchFragment (String mCategry) {
    drawer.closeDrawer();
    getFragmentManager().beginTransaction()
        .replace(com.sspai.navigationdrawer.R.id.frame_container, HomeFragment.newInstance(mCategry))
        .commit();
  }
